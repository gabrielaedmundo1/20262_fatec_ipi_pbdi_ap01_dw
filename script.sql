...
-- 	invoice_id, branch, city, customer_type, gender, product_line, payment, unit_price, 
-- 	quantity, tax_5pct, total, cogs, gross_income, rating, sale_ts
-- )
-- SELECT
-- 	TRIM(invoice_id),
-- 	UPPER(TRIM(branch)),
...
-- 	CAST(TRIM(unit_price) AS NUMERIC(10, 2)),git
...
-- 	CAST(TRIM(gross_income) AS NUMERIC(10, 2)),
